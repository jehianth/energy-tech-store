...
CREATE TABLE `products` (
  ...
  `type` enum('Processor','Motherboard','RAM','HDD','SSD','Casing','GPU','PSU','Keyboard','Mouse','Headset','Cooler','Monitor') COLLATE utf8mb4_unicode_ci NOT NULL,
